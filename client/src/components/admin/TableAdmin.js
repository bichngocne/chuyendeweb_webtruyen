...
const TableAdmin = (props) => {
  ...
  if (props.text === "liststoryadmin") {
    columns = [
      ...
      {
        field: "status_chapter",
        headerName: "Trạng thái truyện",
        width: 100,
        align: "center",
        headerAlign: "center",
        renderCell: (params) => {
          const status = params.value;
          return status ? "Đang ra" : "Full";
        },
      },
      {
        field: "createdAt",
      ...
      },
      {
        ...
        renderCell: (params) => (
          <div className="flex gap-4 items-center">
            <Link to={`detail-story-admin/${params.row.id}`} className="flex">
              <svg
            ...
            <p className="pl-[10px] [font-family:'Roboto-Regular',Helvetica] text-[14px]">Xem</p>
            </Link>
  ...
  } else if (props.text === "listcategoryadmin") {
    columns = [
      {
        field: "STT",
        headerName: "STT",
  ...
  } else if (props.text === "listpendingadmin") {
    columns = [
      {
        field: "STT",
        headerName: "STT",
  ...
  } else if (props.text === "listuseradmin") {
    columns = [
      {
        field: "STT",
        headerName: "STT",
  ...
  }, [data, props.text]);// Ví dụ: Lấy ID từ trường 'id'.
