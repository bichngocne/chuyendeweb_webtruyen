...
const SettingAccoutAdmin = () => {
  ...
  return (
    <div className="relative inline-block text-left">
      <div>
        <button onClick={toggleDropdown}>
          <svg
            ...
            viewBox="0 0 30 30"
          >
            <path fill="url(#iconaccout)" d="M0 0h30v30H0z" />
            <defs>
              <pattern
                id="iconaccout"
                width="1"
              ...
              >
                <use href="#iconaccout1" transform="scale(.01)" />
              </pattern>
              <image
                id="iconaccout1"
                width="100"
      ...
      {isOpen && (
        <div className="origin-top-right absolute right-0 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-[2]">
          {/* Dropdown content */}
          <div className="py-1">
            <a
              href="#"
...
export default SettingAccoutAdmin;
